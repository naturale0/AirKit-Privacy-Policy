...
## 1. 개인정보의 처리 목적
에어킷 (이하 '에어킷', 'AirKit' 또는 '서비스', '앱’이라 합니다.)은 다음의 목적을 위하여 개인정보를 처리하고 있으며 다음의 목적 이외의 용도로는 사용하지 않습니다.
- 현재 위치를 기반으로 한 서비스를 위해 좌표계 전환 및 가까운 대기오염물질 측정소 탐색, 측정치 수신

## 2. 개인정보처리 제3자 제공 및 위탁
에어킷은 개인정보 제3자 제공 및 위탁을 하지 않습니다.
...
## 6. 개인정보 보호책임자에 관한 사항
에어킷은 다음과 같이 개인정보 처리에 관한 업무를 책임지고 불만처리 및 피해구제를 위한 보호책임자를 지정하고 있습니다. 정보주체는 서비스를 이용하면서 발생하는 개인정보 보호 관련 문의를 개인정보 보호책임자에게 문의할 수 있습니다.
...
## 8. 개인정보의 안전성 확보조치
에어킷은 개인정보보호법 제31조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 취하고 있습니다.
...
- 2019년 11월 3일 개정: 앱 및 서비스에 해당되지 않던 Google AdMob 광고식별자 내용 삭제. 개정된 방침은 11월 11일 0시 0분 (한국시간)부터 적용됩니다.
